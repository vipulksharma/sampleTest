...
function MdDialogProvider($$interimElementProvider) {
  ...
  return $$interimElementProvider('$mdDialog')
    .setDefaults({
      methods: ['disableParentScroll', 'hasBackdrop', 'clickOutsideToClose', 'escapeToClose', 'targetEvent', 'parent', 'externalId'],
      options: dialogDefaultOptions
    })
    .addPreset('alert', {
  ...
  function dialogDefaultOptions($mdDialog, $mdAria, $mdUtil, $mdConstant, $animate, $document, $window, $rootElement) {
    return {
      ...
      focusOnOpen: true,
      disableParentScroll: true,
      transformTemplate: function(template, externalId) {
     ...
     */
    function onShow(scope, element, options, controller) {
      element.attr('id', options.externalId);
...
function SelectProvider($$interimElementProvider) {
  ...
  function selectDefaultOptions($mdSelect, $mdConstant, $mdUtil, $window, $q, $$rAF, $animateCss, $animate) {
    ...
    function calculateMenuPositions(scope, element, opts) {
      ...
      if (top + 2*selectMenuRect.height >= bounds.bottom) {
        top = targetRect.top - selectMenuRect.height + targetRect.height;
...
function virtualRepeatContainerTemplate($element) {
  return '<div class="md-virtual-repeat-scroller">' +
    '<div class="md-virtual-repeat-sizer">' +
